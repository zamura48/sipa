    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="{{ route('admin.iuran.create') }}" class="btn btn-primary btn-sm float-right">
                ...
                <table id="data_table" class="table table-striped mt-4">
                    <thead>
                        <tr>
                            ...
                            <th>Total</th>
                            <th>Keterangan</th>
                            <th>Iuran Pendaftaran <br> <small class="text-danger">Hanya bisa diaktifkan salah satu</small>
                            </th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('admin.iuran.destroy', $item->id) }}" method="POST"
