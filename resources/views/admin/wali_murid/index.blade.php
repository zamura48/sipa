    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="{{ route('admin.wali_murid.create') }}" class="btn btn-primary btn-sm float-right">
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.wali_murid.show', $item->id) }}" class="btn btn-info btn-sm">
                                        <i class="fa fa-info mr-2"></i> Detail
                                    </a>
                                    <form action="{{ route('admin.wali_murid.destroy', $item->id) }}" method="POST"
