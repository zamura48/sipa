                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="hero-image" data-aos="zoom-out" data-aos-delay="300">
                            <img src="<?= asset('assets/lib/ilanding') ?>/assets/img/illustration-1.webp"
                                alt="Hero Image" class="img-fluid">

                            <div class="customers-badge">
                                <div class="customer-avatars">
                                    <img src="<?= asset('assets/lib/ilanding') ?>/assets/img/avatar-1.webp"
                                        alt="Customer 1" class="avatar">
                                    <img src="<?= asset('assets/lib/ilanding') ?>/assets/img/avatar-2.webp"
                                        alt="Customer 2" class="avatar">
                                    <img src="<?= asset('assets/lib/ilanding') ?>/assets/img/avatar-3.webp"
                                        alt="Customer 3" class="avatar">
                                    <img src="<?= asset('assets/lib/ilanding') ?>/assets/img/avatar-4.webp"
                                        alt="Customer 4" class="avatar">
                                    <img src="<?= asset('assets/lib/ilanding') ?>/assets/img/avatar-5.webp"
                    ...
                    <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="image-wrapper">
                            <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                                <img src="<?= asset('assets/lib/ilanding') ?>/assets/img/about-5.webp"
                  ...
                  "spaceBetween": 120
                    ...
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><img
                                src="<?= asset('assets/lib/ilanding') ?>/assets/img/clients/client-1.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img
                                src="<?= asset('assets/lib/ilanding') ?>/assets/img/clients/client-2.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img
                                src="<?= asset('assets/lib/ilanding') ?>/assets/img/clients/client-3.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img
                                src="<?= asset('assets/lib/ilanding') ?>/assets/img/clients/client-4.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img
                                src="<?= asset('assets/lib/ilanding') ?>/assets/img/clients/client-5.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img
                                src="<?= asset('assets/lib/ilanding') ?>/assets/img/clients/client-6.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img
                                src="<?= asset('assets/lib/ilanding') ?>/assets/img/clients/client-7.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img
                                src="<?= asset('assets/lib/ilanding') ?>/assets/img/clients/client-8.png"
                                class="img-fluid" alt=""></div>
                    </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="testimonial-item">
                            <img src="<?= asset('assets/lib/ilanding') ?>/assets/img/testimonials/testimonials-1.jpg"
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="testimonial-item">
                            <img src="<?= asset('assets/lib/ilanding') ?>/assets/img/testimonials/testimonials-2.jpg"
                                class="testimonial-img" alt="">
                            <h3>Sara Wilsson</h3>
                            <h4>Designer</h4>
                            <div class="stars">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="testimonial-item">
                            <img src="<?= asset('assets/lib/ilanding') ?>/assets/img/testimonials/testimonials-3.jpg"
                                class="testimonial-img" alt="">
                            <h3>Jena Karlis</h3>
                            <h4>Store Owner</h4>
                            <div class="stars">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="testimonial-item">
                            <img src="<?= asset('assets/lib/ilanding') ?>/assets/img/testimonials/testimonials-4.jpg"
                                class="testimonial-img" alt="">
                            <h3>Matt Brandon</h3>
                            <h4>Freelancer</h4>
                            <div class="stars">
