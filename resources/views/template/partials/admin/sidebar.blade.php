...
<ul class="navbar-nav sidebar accordion" id="accordionSidebar">
    ...
    @if (auth()->user()->role_id == 1)
        ...
        <li class="nav-item {{ $sub_modul == 'iuran' || $sub_modul == 'jenis_iuran' || $sub_modul == 'keringanan' ? 'active' : '' }}">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#iuran"
                aria-expanded="true" aria-controls="iuran">
                <i class="fas fa-fw fa-folder"></i>
                <span>Iuran</span>
            </a>
            <div id="iuran" class="collapse {{ $sub_modul == 'iuran' || $sub_modul == 'jenis_iuran' || $sub_modul == 'keringanan' ? 'show' : '' }}" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header"></h6>
                    <a class="collapse-item {{ $sub_modul == 'jenis_iuran' ? 'active' : '' }}" href="{{ route('admin.jenis_iuran.index') }}">Jenis Iuran</a>
                    <a class="collapse-item {{ $sub_modul == 'iuran' ? 'active' : '' }}" href="{{ route('admin.iuran.index') }}">Iuran</a>
                    <a class="collapse-item {{ $sub_modul == 'keringanan' ? 'active' : '' }}" href="{{ route('admin.keringanan.index') }}">Keringanan</a>
                </div>
            </div>
        </li>

        <li class="nav-item {{ $sub_modul == 'role' || $sub_modul == 'siswa' || $sub_modul == 'pengguna' || $sub_modul == 'user' ? 'active' : '' }}">
